...
- Be careful; this function won't work always; the second and beyond file might not contain the required soundchip initialisation
- For SCC it works fine, but for Moonsound it won't because of this. This can be fixed as well, but that'll require a lot more work, better use the vgm_tools for splitting those.
